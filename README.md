...
just thestral-talos apply-cluster

# Bootstrap Flux
just thestral-bootstrap
```
...
just thestral-talos render-config thestral-01
just thestral-talos apply-node thestral-01
```
...
just thestral-talos upgrade-node thestral-01

# Upgrade the Kubernetes control-plane version
just thestral-talos upgrade-k8s <version>
```
